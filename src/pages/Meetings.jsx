  ...
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-4 bg-white rounded-3xl border border-gray-200 shadow-xl overflow-hidden relative">
      ...
      <div className="relative z-10 max-w-lg mx-auto">
        <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-[#caa74a] to-[#8f6b10] rounded-2xl flex items-center justify-center text-white text-3xl shadow-lg animate-pulse">
          📅
        </div>
        ...
        <p className="text-[#caa74a] font-semibold tracking-wider uppercase text-sm mb-6">
          Book a Session with Design Experts
        </p>
        
        <p className="text-gray-600 text-lg mb-8">
          Connect directly with professional interior designers to review your AI concepts, receive expert advice, and finalize your home blueprints.
        </p>
